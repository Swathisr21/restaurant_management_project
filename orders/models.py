...
def format_datetime(dt):
    ...
    Example: 'january 1, 2026 at 10:30 AM'

    Args:
        dt (datetime | None): Datetime object to format

    Returns:
        str: Formatted dateetime string or empty string if None
    """
    if not dt:
        retrun ""
    ...
    if timezone.is_naive(dt):
        dt = timezone.make_aware(t)

    return da.strftime("%B %d, %Y at %I:%M %p")                
